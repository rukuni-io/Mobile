...
const AVATAR_PALETTE = [
    { bg: 'rgba(110, 181, 255, 0.15)', fg: '#6eb5ff' },
...
const NOTIF_TYPE_CONFIG: { [key: string]: { icon: string; color: string; colorSoft: string; cta: string } } = {
    login:               { icon: '🔐', color: '#6eb5ff', colorSoft: 'rgba(110,181,255,0.10)', cta: 'View Details' },
    group_created:       { icon: '🏦', color: '#6eb5ff', colorSoft: 'rgba(110,181,255,0.10)', cta: 'View Group' },
    group_joined:        { icon: '🏦', color: '#6eb5ff', colorSoft: 'rgba(110,181,255,0.10)', cta: 'View Group' },
    ...
    group_starting:      { icon: '🚀', color: '#6eb5ff', colorSoft: 'rgba(110,181,255,0.10)',   cta: 'View Schedule' },
    ...
    default:             { icon: '🔔', color: '#6eb5ff', colorSoft: 'rgba(110,181,255,0.10)', cta: 'View' },
};
